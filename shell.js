...
var locations = ["/", "home", "classyvaibhav", ""]; // user directories
var whereWeAt = locations[2]; // global var for current location
var currentUser = "classyvaibhav"; // Set the username
...
$("#shell").keydown(function (e) {
  ...
  if (e.which == 13) { // enter key (13)
    ...
    if (whereWeAt == locations[2]) { // home dir of username
      print("[" + currentUser + "@github ~]$ " + input);
    } else {
      print(currentUser + "@github " + whereWeAt + "] " + input);
    }
