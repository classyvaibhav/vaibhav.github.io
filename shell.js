...
var locations = ["/", "home", "classyvaibhav", ""]; // Use 'classyvaibhav' instead of 'feelqah'

var whereWeAt = locations[2]; // Initialize to the 'classyvaibhav' location
...
$("#shell").keydown(function (e) {
  ...
  if (e.which == 13) { // enter key (13)
    ...
    // Print the shell prompt with 'classyvaibhav' username
    if (whereWeAt == locations[2]) { // home dir of classyvaibhav
      print("[classyvaibhav@github ~]$ " + input);
    } else {
      print("[classyvaibhav@github " + whereWeAt + "]$ " + input);
    }
